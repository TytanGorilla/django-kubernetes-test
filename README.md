...
```bash
docker build --no-cache -t tytan22/django-app:1.0.20250209 .
docker build -t tytan22/django-app:1.0.20250209 .
```
### Pushing the Docker Image to Docker Hub
```bash
docker push tytan22/django-app:1.0.20250209
```
### Updating django-app Deployment to use the new Docker Image
```yaml
containers:
- name: django-container
  image: tytan22/django-app:1.0.20250209 # Update this line to use the new image that is dated
