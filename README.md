...
```bash
docker build -t tytan22/django-app:1.0.20250202 .
```
### Pushing the Docker Image to Docker Hub
```bash
docker push tytan22/django-app:1.0.20250202
```
### Updating django-app Deployment to use the new Docker Image
```yaml
containers:
- name: django-container
  image: tytan22/django-app:1.0.20250202 # Update this line to use the new image that is dated
